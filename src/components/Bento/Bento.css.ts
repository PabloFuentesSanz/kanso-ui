...
export const bentoStyles = recipe({
  ...
  variants: {
    ...
    gap: {
      none: { gap: vars.spacing['0'] },
      xs: { gap: vars.spacing['1'] },   // 4px
      sm: { gap: vars.spacing['2'] },   // 8px
      md: { gap: vars.spacing['4'] },   // 16px
      lg: { gap: vars.spacing['6'] },   // 24px
      xl: { gap: vars.spacing['8'] },   // 32px
      '2xl': { gap: vars.spacing['12'] }, // 48px
    },
  ...
  defaultVariants: {
    columns: '3', // A nice default for a bento box
    gap: 'md',
    align: 'stretch',
    justify: 'stretch',
  },
